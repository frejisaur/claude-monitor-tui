...
_TAB_HELP: dict[str, str] = {
    "tab-overview": """\
[bold underline]Overview Tab[/bold underline]
High-level summary of Claude Code usage and spending.

[dim]━━━ Metrics ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Total Tokens[/bold]     All tokens processed (input + output + cache).
  [bold]Est. API Cost[/bold]    Estimated dollar cost based on per-model pricing.
  [bold]Sessions[/bold]         Number of Claude Code sessions in the period.
  [bold]Achievement[/bold]      % of sessions that achieved their goal.

[dim]━━━ Stacked Bar Chart ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Shows estimated cost by token type over time.

  [bold]Token types:[/bold]
    [bold]Input[/bold]         New tokens sent to the model each turn.
    [bold]Output[/bold]        Tokens generated by the model.
    [bold]Cache Read[/bold]    Previously cached tokens reused (discounted).
    [bold]Cache Write[/bold]   New tokens written to the prompt cache.

[dim]━━━ Cost Breakdown Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Per-model breakdown of token counts and estimated costs.
  Click a column header to sort.

[dim]Press Escape to close.[/dim]\
""",
    "tab-effectiveness": """\
[bold underline]Effectiveness Tab[/bold underline]
Measures whether Claude sessions achieve their goals, not just what they cost.

[dim]━━━ Data Sources ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [green bold]Facet[/green bold]  AI-judged session analysis (outcome, friction, goal
         categories). Generated by running [bold]/insights[/bold] in Claude Code.

  [dim bold]Proxy[/dim bold]  Heuristic estimate when no facet exists. Uses signals
         like git commits, tool error rate, user interruptions,
         and duration.
...
[dim]━━━ Metrics ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]
  ...
  [bold]Achievement[/bold]      % of sessions that achieved their goal
                   (fully/mostly/likely).
  [bold]Avg Friction[/bold]     Average friction events per session
                   (tool errors, rejections, etc).
  [bold]Avg Efficiency[/bold]   Session cost / average cost for its goal category.
                   <1x = cheaper, >1x = more expensive.

[dim]━━━ Tables ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Friction[/bold]   Types ranked by frequency. "Avg Extra Cost" = how
             much more expensive those sessions are vs average.
  [bold]Category[/bold]   Sessions by goal category with per-category
             achievement rates and efficiency scores.

[dim]━━━ Outcome Labels ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [green]fully[/green]    Fully achieved        [dim green]~likely[/dim green]   Likely achieved
  [yellow]mostly[/yellow]   Mostly achieved       [dim]~unclear[/dim]  Unclear
  [red]not[/red]      Not achieved          [dim red]~not[/dim red]      Likely not achieved
  [dim]         ── facet ──           [/dim][dim]          ── proxy ──[/dim]

[dim]Press Escape to close.[/dim]\
""",
    "tab-sessions": """\
[bold underline]Sessions Tab[/bold underline]
Detailed view of individual Claude Code sessions.

[dim]━━━ Metrics ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Today's Spend[/bold]    Cost of sessions started today.
  [bold]7d Avg[/bold]           Average daily cost over the last 7 days.
  [bold]Median Cost[/bold]      Median cost per session.
  [bold]Efficiency[/bold]       Efficiency score (cache hit + cost-per-turn).
  [bold]30d Sessions[/bold]     Total sessions in the last 30 days.

[dim]━━━ Heatmap ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Sessions by day of week and hour. Darker = more sessions.
  Reveals when you use Claude Code most.

[dim]━━━ Sessions Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Efficiency[/bold]   Composite score combining cache hit rate and
               cost-per-turn. Higher = more efficient.
  [bold]Cache%[/bold]       Percentage of input tokens served from cache.
  [bold]Outcome[/bold]      Session outcome (fully/mostly/not achieved).
  [bold]Friction[/bold]     Number of friction events in the session.

  Click a row to expand session detail.
  Click a column header to sort.

[dim]Press Escape to close.[/dim]\
""",
    "tab-projects": """\
[bold underline]Projects Tab[/bold underline]
Aggregated usage by project directory.

[dim]━━━ Projects Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Each row is a project directory where Claude Code was run.
  Shows aggregated token counts and estimated costs.

  [bold]Project[/bold]      Directory path (shortened to last components).
  [bold]Sessions[/bold]     Number of sessions in this project.
  [bold]Tokens[/bold]       Total tokens consumed.
  [bold]Cost[/bold]         Estimated API cost.
...
""",
    "tab-models": """\
[bold underline]Models Tab[/bold underline]
Cost and usage breakdown by Claude model.

[dim]━━━ Bar Chart ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Estimated cost per model. Quickly see which models
  drive the most spending.

[dim]━━━ Models Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Model[/bold]        Model name (e.g. claude-sonnet-4-...).
  [bold]Input[/bold]        Cost from input tokens.
  [bold]Output[/bold]       Cost from output tokens.
  [bold]Cache[/bold]        Combined cache read + write cost.
  [bold]Total[/bold]        Sum of input + output + cache costs.
  [bold]Share[/bold]        Percentage of total spend from this model.
...
""",
    "tab-subagents": """\
[bold underline]Subagents Tab[/bold underline]
Usage of Task tool delegations (subagents) across sessions.

[dim]━━━ What are Subagents? ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Subagents are autonomous agents spawned via the Task tool.
  Each handles a self-contained subtask (research, code review,
  test running, etc.) and returns results to the main session.

[dim]━━━ Bar Chart ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Number of calls per subagent type.

[dim]━━━ Subagents Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Subagent[/bold]     Name/type of the subagent.
  [bold]Calls[/bold]        Number of times invoked.
  [bold]Avg Tokens[/bold]   Average tokens per invocation.
  [bold]Cost[/bold]         Total estimated cost.

[dim]━━━ Descriptions Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Shows the description passed to each subagent type,
  helping you understand what each one does.

[dim]Press Escape to close.[/dim]\
""",
    "tab-skills": """\
[bold underline]Skills Tab[/bold underline]
Usage and cost analysis of Claude Code skills (slash commands).

[dim]━━━ Metrics ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Invocations[/bold]      Total skill invocations across all sessions.
  [bold]Unique Skills[/bold]    Number of distinct skills used.
  [bold]Avg w/ Skills[/bold]    Average session cost when skills were used.
  [bold]Avg w/o Skills[/bold]   Average session cost without any skills.
  [bold]Cache Hit[/bold]        Cache read rate in skill-using sessions.

[dim]━━━ Usage Chart ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  Number of invocations per skill.

[dim]━━━ Skills Table ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[/dim]

  [bold]Skill[/bold]        Skill name (e.g. commit, review-pr).
  [bold]Calls[/bold]        Number of invocations.
  [bold]Avg Cost[/bold]     Average cost per invocation.
  [bold]Cost Delta[/bold]   Cost difference vs sessions without this skill.
                Positive = more expensive, negative = cheaper.
  [bold]Cache R:W[/bold]    Ratio of cache reads to writes. Higher means
               more reuse of cached context.
...
class TabHelp(ModalScreen):
    """Modal help screen showing context-sensitive help for the active tab."""
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="tab-help"):
            yield Static(self._help_content)
...
class HelpCommands(Provider):
    """Command palette provider for help actions."""

    async def search(self, query: str) -> Hits:
        matcher = self.matcher(query)
        score = matcher.match("Help — explain current tab metrics and layout")
        if score > 0:
            yield Hit(
                score,
                matcher.highlight("Help — explain current tab metrics and layout"),
                self.app.action_help,
            )


class SpendApp(App):
    COMMANDS = App.COMMANDS | {HelpCommands}
    CSS = """
    BigNumber {
        text-align: center;
        padding: 0 2;
...
.tab-content {
            ...
            with TabPane("Effectiveness", id="tab-effectiveness"):
                if self.data.effectiveness_agg and self.data.effectiveness:
                    ...
                    with Horizontal(id="effectiveness-numbers"):
                        yield BigNumber("Analyzed", f"{agg.faceted_count} facet / {agg.proxied_count} proxy / {agg.total_sessions}")
    ...
    def action_help(self) -> None:
        ...
        pane_id = tc.active
        content = _TAB_HELP.get(pane_id, _TAB_HELP["tab-overview"])
        self.push_screen(TabHelp(content))
